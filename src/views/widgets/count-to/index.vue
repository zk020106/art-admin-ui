...
<template>
  <div class="page-content mb-5">
    ...
    <!-- 基础用法 -->
    <div class="mb-15">
      <h2 class="m-0 mb-6 text-xl font-medium">
        基础用法
      </h2>
      <div class="count">
    ...
    <div class="mb-15">
      ...
      <div class="grid grid-cols-[repeat(auto-fit,minmax(200px,1fr))] gap-6 mb-8">
        <div v-for="easing in easingTypes" :key="easing.type" class="text-center">
          <div class="mb-3 text-sm font-medium text-g-700">
            {{ easing.name }}
          </div>
          <div class="count">
    ...
    <div class="mb-15">
      ...
      <div class="flex gap-3 justify-center">
        <ElButton @click="startCount">
          开始
        </ElButton>
        <ElButton @click="pauseCount">
          暂停
        </ElButton>
        <ElButton @click="resetCount">
          重置
        </ElButton>
      </div>
    </div>
