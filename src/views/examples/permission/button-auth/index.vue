        ...
        <div>
          ...
          <div class="grid grid-cols-[repeat(auto-fit,minmax(280px,1fr))] gap-5">
            <div class="flex flex-col gap-2">
              <ElButton v-roles="'R_SUPER'" type="primary" plain>
                超级管理员可见
              </ElButton>
              <div class="text-xs">
            ...
            <!-- 管理员级别按钮 -->
            <div class="flex flex-col gap-2">
              <ElButton v-roles="['R_SUPER', 'R_ADMIN']" type="warning" plain>
                管理员可见
              </ElButton>
              <div class="text-xs">
            ...
            <!-- 所有已登录用户可见 -->
            <div class="flex flex-col gap-2">
              <ElButton v-roles="['R_SUPER', 'R_ADMIN', 'R_USER']" type="success" plain>
                所有用户可见
              </ElButton>
              <div class="text-xs">
                <code class="block p-1 px-2 mb-1 font-mono bg-g-200 border-full-d rounded">v-roles="['R_SUPER', 'R_ADMIN', 'R_USER']"</code>
      ...
      <ElCard shadow="never" class="art-card-xs">
        ...
        <div>
          ...
          <div class="grid grid-cols-[repeat(auto-fit,minmax(280px,1fr))] gap-5">
            <!-- 新增权限 -->
            <div class="flex flex-col gap-2">
              <ElButton v-auth="'add'" type="primary" plain>
                新增
              </ElButton>
              <div class="text-xs">
            ...
            <!-- 编辑权限 -->
            <div class="flex flex-col gap-2">
              <ElButton v-auth="'edit'" type="warning" plain>
                编辑
              </ElButton>
              <div class="text-xs">
            ...
            <!-- 删除权限 -->
            <div class="flex flex-col gap-2">
              <ElButton v-auth="'delete'" type="danger" plain>
                删除
              </ElButton>
              <div class="text-xs">
            ...
            <!-- 导出权限 -->
            <div class="flex flex-col gap-2">
              <ElButton v-auth="'export'" type="info" plain>
                导出
              </ElButton>
              <div class="text-xs">
        ...
        <div>
          ...
          <div class="grid grid-cols-[repeat(auto-fit,minmax(280px,1fr))] gap-5">
            ...
            <div class="flex flex-col gap-2">
              ...
              <div class="text-xs">
                <code class="block p-1 px-2 mb-1 font-mono bg-g-200 border-full-d rounded">computed(() => hasAuth('edit') || hasAuth('delete'))</code>
