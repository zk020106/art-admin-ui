          ...
          <ElForm :model="connectForm" label-width="100px" class="max-w-md">
            ...
            <ElFormItem>
              <ElSpace>
                ...
                <ElButton type="danger" :disabled="!isConnected" @click="handleDisconnect">
                  断开连接
                </ElButton>
                <ElButton :disabled="isConnecting" @click="handleReconnect">
                  重连
                </ElButton>
              </ElSpace>
            </ElFormItem>
          ...
          <ElForm :model="messageForm" @submit.prevent="handleSendMessage">
            ...
            <ElFormItem>
              <ElSpace>
                ...
                <ElButton @click="clearMessageForm">
                  清空
                </ElButton>
              </ElSpace>
            </ElFormItem>
    ...
    <ElCard class="border-0" shadow="never">
      <template #header>
        <div class="flex items-center justify-between">
          ...
          <ElButton size="small" @click="clearLogs">
            清空日志
          </ElButton>
        </div>
      </template>
