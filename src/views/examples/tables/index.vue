      ...
      <template #header>
        <div class="flex-cb">
          ...
          <div class="flex gap-2">
            <ElTag v-if="error" type="danger">
              {{ error.message }}
            </ElTag>
            <ElTag v-else-if="loading" type="warning">
              加载中...
            </ElTag>
      ...
      >
        <template #left>
          <ElSpace wrap>
            ...
            <ElButton v-ripple plain @click="handleClearData">
              清空数据
            </ElButton>
    ...
    <ElCard shadow="never" class="art-card-xs">
      ...
      <div class="flex flex-col gap-6">
        ...
        <div class="p-4 bg-g-200 border-full-d rounded-lg">
          <h5 class="m-0 mb-4 text-sm font-semibold">
            事件监听演示
          </h5>
          <div class="flex flex-wrap gap-2 mb-3 last:mb-0">
            ...
            <ElButton v-if="eventDemoEnabled" @click="clearEventLogs">
              清空日志
            </ElButton>
          </div>
          <div
        ...
        <div class="p-4 bg-g-200 border-full-d rounded-lg">
          ...
          <div class="flex flex-wrap gap-2 mb-3 last:mb-0">
            <ElButton @click="handleScrollToTop">
              滚动到顶部
            </ElButton>
            <ElButton @click="handleScrollToPosition">
              滚动到指定位置
            </ElButton>
            <ElButton @click="handleToggleSelection">
              切换全选
            </ElButton>
            <ElButton @click="handleGetTableInfo">
              获取表格信息
            </ElButton>
          </div>
        </div>
