  ...
  <div class="pb-5">
    ...
    <div class="mt-3.5">
      ...
      <ElSpace wrap class="mb-3">
        ...
        <ElButton @click="addFormItem">
          新增表单项
        </ElButton>
        <ElButton @click="updateFormItem">
          修改表单项
        </ElButton>
        <ElButton @click="deleteFormItem">
          删除表单项
        </ElButton>
        <ElButton @click="batchAddFormItems">
          批量新增
        </ElButton>
        <ElButton @click="resetDynamicItems">
          重置动态项
        </ElButton>
      </ElSpace>
      ...
      <ElSpace wrap>
        ...
        <ElButton @click="labelWidth = 120">
          修改 label 宽度
        </ElButton>
        <ElButton @click="span = 8">
          设置一行显示的组件数
        </ElButton>
        <ElButton @click="gutter = 50">
          修改 gutter
        </ElButton>
        <ElButton @click="labelPosition = 'left'">
          label 左对齐
        </ElButton>
        <ElButton @click="labelPosition = 'right'">
          label 右对齐
        </ElButton>
        <ElButton @click="labelPosition = 'top'">
          label 顶部对齐
        </ElButton>
      </ElSpace>
    </div>
